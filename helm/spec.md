...
## Best practise
  ...
  ### 3. Ensure Secrets Are Secure

  ### 4. Make your Chart Resuable by Using Template Functions
...
    region: {{ .Values.region | upper | quote }}  
  ...
  ```
  ### 5. Update your Deployment When ConfigMaps or Secrets change
...
          checksum/config: {{ include (print $.Template.BasePath "/configmap.yaml") . | sha256sum }}
 ...
 ### 6. Useful Commands for Debugging Helm Charts
